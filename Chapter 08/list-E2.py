...
# and then modify the program so that the line is properly guarded and test 
...
for line in fhand:
    ...
    print(words[2]) # issue is on this line, if there is no words after From, it will fail.
